class NetworkAgent extends Observable {
     ...
     */
    constructor(blockchain, addresses, services, channel) {
        super();
        /** @type {IBlockchain} */
    ...
    handshake() {
        ...
        if (!this._channel.version(NetworkConfig.myPeerAddress(this._services), this._blockchain.headHash)) {
    ...
    _finishHandshake() {
        ...
        this._timers.setInterval('announce-addr',
            () => this._channel.addr([NetworkConfig.myPeerAddress(this._services)]),
    ...
    _requestAddresses() {
        ...
        this._channel.getAddr(NetworkConfig.myProtocolMask(), this._services.accepted);
