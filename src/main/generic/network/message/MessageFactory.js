...
MessageFactory.CLASSES[Message.Type.GET_INTERLINK_CHAIN] = GetInterlinkChainMessage;
MessageFactory.CLASSES[Message.Type.INTERLINK_CHAIN] = InterlinkChainMessage;
...
MessageFactory.CLASSES[Message.Type.GET_HEADERS] = GetHeadersMessage;
MessageFactory.CLASSES[Message.Type.HEADERS] = HeadersMessage;
