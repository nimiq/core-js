...
if (!offlineTarget) {
    Dummy.NETCONFIG = new WssNetworkConfig('node1.test', 9000, 'key1', 'cert1', { enabled: false, port: 8444, address: '::ffff:127.0.0.1', header: 'x-forwarded-for', terminatesSsl: false});
