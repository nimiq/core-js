...
void ed25519_add_points(unsigned char *point_AB, const unsigned char *point_A, const unsigned char *point_B) {
    ...
    ge_p3_to_cached(&pA, &point_A_unpacked);
    ...
    ge_p3_to_cached(&pB, &point_B_unpacked);
