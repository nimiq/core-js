...
**[Nimiq](https://nimiq.com/)** is a frictionless payment protocol for the web. It is able to run in browsers. [Safe](https://safe.nimiq.com) [Miner](https://miner.nimiq.com)
