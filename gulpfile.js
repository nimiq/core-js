...
const sources = {
    ...
    generic: [
        ...
        './src/main/generic/consensus/base/account/tree/ChunkPartialAccountsTree.js',
        './src/main/generic/consensus/base/account/tree/ProofPartialAccountsTree.js',
        './src/main/generic/consensus/base/account/Accounts.js',
        './src/main/generic/consensus/base/account/PartialAccounts.js',
        ...
        './src/main/generic/consensus/lighter/LighterChain.js',
        './src/main/generic/consensus/lighter/LighterConsensus.js',
        './src/main/generic/consensus/lighter/LighterConsensusAgent.js',
        './src/main/generic/consensus/lighter/PartialLighterChain.js',
